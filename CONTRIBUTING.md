...
4. **Configuration comes from the environment.** Chat, model and archive endpoints and their tokens
   have no defaults baked in. A service that silently starts pointed at someone else's endpoint is
...
Include what you expected, what happened, and the smallest reproduction — the connector and channel
